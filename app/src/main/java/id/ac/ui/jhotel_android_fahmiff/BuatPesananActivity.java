...
public class BuatPesananActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent buatpesanan = getIntent();
        Bundle b = buatpesanan.getExtras();
        if (b != null) {
        ...
        hitung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(TextUtils.isEmpty(durasi.getText().toString())){
                    durasi.setError("Durasi is required!");
                }
                else{
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (jsonResponse != null) {
                                ...
                                builder.setMessage("Pesanan Berhasil Dilakukan :)")
                                        .create()
                                        .show();
                            }
                        } catch (JSONException e) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(BuatPesananActivity.this);
                            builder.setMessage("Pesanan Gagal Dilakukan :(")
                                    .create()
                                    .show();
                        }
                    }
                ...
                Response.Listener<String> responseListener = new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(BuatPesananActivity.this);
                            builder.setMessage("PPesanan Gagal Dilakukan :(")
                                    .create()
                                    .show();
                        }
                    }
